...
class TestTestUpdateUnit(unittest.TestCase):
    ...
    def test_update_with_x509_and_no_certificate_fails(self):
        with self.assertRaises(CLIError) as context:
            update(self, test_id=self.test_id, attestation_type=AttestationType.x509.value)
    ...
    def test_update_with_tpm_and_no_endorsement_key_fails(self):
        with self.assertRaises(CLIError) as context:
            update(self, test_id=self.test_id, attestation_type=AttestationType.tpm.value)
    ...
    def test_update_symmetric_key_to_cert(self, mock_from_get, mock_sdk_update, mock_read_certificate):
        ...
        update(self, test_id=self.test_id, attestation_type=AttestationType.x509.value, certificate_path='mycertificate.cer')
    ...
    def test_update_symmetric_key_to_tpm(self, mock_from_get, mock_sdk_update):
        ...
        mock_from_get.return_value = return_data
        update(self, test_id=self.test_id, attestation_type=AttestationType.tpm.value, endorsement_key='endorsement_key')
        mock_sdk_update.assert_called_with(
            device_test_id=self.test_id,
            generate_provisioning_configuration=True,
            raw=True,
    ...
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.update_device_test')
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.get_device_test')
    def test_update_symmetric_key_to_symmetric_key(self, mock_from_get, mock_sdk_update):
        mock_test_data = {
            'certificationBadgeConfigurations': [
                {
                'type': 'IotDevice'
        ...
        mock_from_get.return_value = return_data
        update(self, test_id=self.test_id, attestation_type=AttestationType.symmetricKey.value)
        mock_sdk_update.assert_called_with(
            device_test_id=self.test_id,
            generate_provisioning_configuration=True,
            raw=True,
    ...
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.update_device_test')
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.get_device_test')
    def test_update_iotdevice_to_pnp(self, mock_from_get, mock_sdk_update, mock_process_models):
        ...
        mock_from_get.return_value = return_data
        update(self, test_id=self.test_id, badge_type=BadgeType.Pnp.value, models="model_folder")
    ...
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.update_device_test')
    @mock.patch('azext_iot.sdk.product.aicsapi.AICSAPI.get_device_test')
    def test_update_pnp_to_iotdevice(self, mock_from_get, mock_sdk_update, mock_process_models):
        mock_test_data = {
            'certificationBadgeConfigurations': [
                {
                    'type': BadgeType.Pnp.value,
