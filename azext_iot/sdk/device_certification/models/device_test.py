...
class DeviceTest(Model):
    ...
    :param validation_type:
     ...
     'Certification'
    :type validation_type: str or ~device_certification.models.enum
    ...
    :param device_type: Microsoft.Azure.IoT.TestKit.Shared.Models.DeviceType
     ...
     'DevKit'
    :type device_type: str or ~device_certification.models.enum
    :param provisioning_configuration:
    :type provisioning_configuration:
     ~device_certification.models.ProvisioningConfiguration
    ...
    def __init__(self, **kwargs):
        ...
        self.provisioning_configuration = kwargs.get('provisioning_configuration', None)
        self.certification_badge_configurations = kwargs.get('certification_badge_configurations', None)
