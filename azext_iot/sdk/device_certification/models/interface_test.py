...
class InterfaceTest(Model):
    ...
    :type property_tests: list[~device_certification.models.PropertyTest]
    :param command_tests:
    :type command_tests: list[~device_certification.models.CommandTest]
    :param telemetry_tests:
    :type telemetry_tests: list[~device_certification.models.TelemetryTest]
    """
