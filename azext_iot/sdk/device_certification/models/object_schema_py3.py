...
class ObjectSchema(Model):
    ...
    :param fields:
    :type fields: list[~device_certification.models.SchemaField]
    ...
    def __init__(self, *, fields=None, schema_type=None, name: str=None, comment: str=None, display_name=None, id: str=None, description=None, language_version: int=None, **kwargs) -> None:
