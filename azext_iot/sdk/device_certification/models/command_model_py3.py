...
class CommandModel(Model):
    ...
    :type request_schema: ~device_certification.models.SchemaField
    :param response_schema:
    :type response_schema: ~device_certification.models.SchemaField
    :param command_execution_type: Possible values include: 'Synchronous',
     'Asynchronous'
    :type command_execution_type: str or ~device_certification.models.enum
    :param name:
    :type name: str
    :param comment:
    :type comment: str
